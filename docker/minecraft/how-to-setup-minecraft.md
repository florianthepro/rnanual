...
First download the script file [setup-minecraft-full.sh](https://florianthepro.github.io/rnanual/minecraft/setup-minecraft-full.sh) so that it is placed loosely in your Downloads folder on Windows.
