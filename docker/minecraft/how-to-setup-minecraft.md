...
First download the script file [setup-minecraft.sh](https://florianthepro.github.io/docs/minecraft/setup-minecraft.sh) so that it is placed loosely in your Downloads folder on Windows.
