...
Lade zuerst die Skriptdatei [setup.sh](https://florianthepro.github.io/docs/minecraft/setup.sh) herunter, sodass sie sich lose im Downloads-Ordner unter Windows befindet.
