...
Lade zuerst die Skriptdatei [setup-minecraft.sh](https://florianthepro.github.io/docs/minecraft/setup-minecraft.sh) herunter, sodass sie sich lose im Downloads-Ordner unter Windows befindet.
